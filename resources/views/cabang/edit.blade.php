...
@section('content')
    ...
    <form action="{{ route('cabang.update', $cabang) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('kode_cabang') is-invalid @enderror" id="kode_cabang" name="kode_cabang" value="{{ old('kode_cabang', $cabang->kode_cabang) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nama_cabang') is-invalid @enderror" id="nama_cabang" name="nama_cabang" value="{{ old('nama_cabang', $cabang->nama_cabang) }}">
